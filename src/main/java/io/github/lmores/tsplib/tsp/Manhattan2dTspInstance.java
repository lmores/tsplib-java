...
public class Manhattan2dTspInstance extends TspInstance {
  public Manhattan2dTspInstance(
  ...
  protected Manhattan2dTspInstance(final TsplibFileData data) {
    super(data);
  }
  ...
  public int getEdgeWeight(final int i, final int j) {
    ...
    return TsplibUtil.roundedManhattanDistance(x[0], x[1], y[0], y[1]);
  }
}